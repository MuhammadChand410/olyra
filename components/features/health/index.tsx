                ...
                <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-1 px-3 py-2.5 w-80 border border-[#E9EAEB] rounded-md bg-white">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M14.0001 14L11.1335 11.1333M12.6667 7.33333C12.6667 10.2789 10.2789 12.6667 7.33333 12.6667C4.38781 12.6667 2 10.2789 2 7.33333C2 4.38781 4.38781 2 7.33333 2C10.2789 2 12.6667 4.38781 12.6667 7.33333Z" stroke="#71717A" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <input
                            value={search}
